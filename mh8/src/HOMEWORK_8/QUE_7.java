...
public class QUE_7 {
    ...
    public static void main (String [] args) {
        ...
        //should return 0,the first digit and the last digit is 0 since we only have 1 digit, which
        //gives us 0+0 and the sum is 0
        System.out.println(sumFirstAndLastDigit(0));
        //should return 10, the first digit and the last digit is 5 since we only have 1 digit, which
        //
        //gives us 5+5 and the sum is 10.
